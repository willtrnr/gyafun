...
# Jumps
OP_JMP = 0x1B # Jump to instruction
OP_IVK = 0x1C # Pop n values and invoke subroutine setting up a new stack frame with popped values as locals

# Branching
OP_IZR = 0x1D # Pop value and if equal to 0 jump to address
OP_INZ = 0x1E # Pop value and if not equal to 0 jump to address
OP_IEQ = 0x1F # Pop 2 values and if equal jump to program address
OP_INE = 0x20 # Pop 2 values and if not equal jump to program address
OP_ILT = 0x21 # Pop 2 values and if first is less then second jump to program address
OP_IGT = 0x22 # Pop 2 values and if first is greater then second jump to program address
OP_IIN = 0x23 # Pop 1 value and if null jump to program address
OP_INN = 0x24 # pop 1 value and if not null jump to program address
